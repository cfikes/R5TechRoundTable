...
param(
    ...
    [string]$VNCDownload = "https://www.tightvnc.com/download/2.8.79/tightvnc-2.8.79-gpl-setup-64bit.msi",
...
$VNCLocal = "$(Get-Location)\TightVNC.msi"
...
if($Remove){
    # Begin Removal
    Write-Host "Removing VNC From $($ComputerName)"
    # Start Deployment      
    try {
