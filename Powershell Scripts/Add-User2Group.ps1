...
function Choose-ADGroupList($listObject) {
...
} # End Function Choose-ADGroupList

function Choose-Confirmation($OU, $Group) {
    Add-Type -AssemblyName System.Windows.Forms
    Add-Type -AssemblyName System.Drawing
    ...
    $OUMsglabel = New-Object System.Windows.Forms.Label
    $OUMsglabel.Location = New-Object System.Drawing.Point(10,20)
    $OUMsglabel.Size = New-Object System.Drawing.Size(280,20)
    $OUMsglabel.Text = "Add Active Users In:"
    $form.Controls.Add($OUMsglabel)

    $OUlabel = New-Object System.Windows.Forms.Label
    $OUlabel.Location = New-Object System.Drawing.Point(10,40)
    $OUlabel.Size = New-Object System.Drawing.Size(280,60)
    $OUlabel.Text = "$OU"
    $form.Controls.Add($OUlabel)

    $GroupMsglabel = New-Object System.Windows.Forms.Label
    $GroupMsglabel.Location = New-Object System.Drawing.Point(10,140)
    $GroupMsglabel.Size = New-Object System.Drawing.Size(280,20)
    $GroupMsglabel.Text = "Into Group:"
    $form.Controls.Add($GroupMsglabel)

    $Grouplabel = New-Object System.Windows.Forms.Label
    $Grouplabel.Location = New-Object System.Drawing.Point(10,160)
    $Grouplabel.Size = New-Object System.Drawing.Size(280,40)
